...
#define STRING_CONFIG_H_AUTHOR "(Robert Thompson)" // Original author or contributor.
...
// Custom/non-standard connections
#define FAN1_PIN           P2_07  // use the HE0 output
#define FAN0_PIN           P2_04  // use the HE1 output
...
#define CUSTOM_MACHINE_NAME "Clunker"
//#define CONFIGURABLE_MACHINE_NAME // Add G-code M550 to set/report the machine name

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "6a15aacd-5a3e-414b-aa6d-e4dd8b9f2873"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_KP  21.5916
    #define DEFAULT_KI   1.7716
    #define DEFAULT_KD  65.7870
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 257.3740
  #define DEFAULT_BED_KI  51.0410
  #define DEFAULT_BED_KD 865.2057
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 94.34 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 2000, 200, 10000}
...
#define XY_PROBE_FEEDRATE    (6000) // (mm/min)

// Feedrate for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST  (240) // (mm/min)

// Feedrate for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (180) // (mm/min)
