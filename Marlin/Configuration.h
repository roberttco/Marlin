...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  16.4812
    #define DEFAULT_Ki   0.8066
    #define DEFAULT_Kd  84.1900
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 190.1281
  #define DEFAULT_bedKi  35.9210
  #define DEFAULT_bedKd 670.3280
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 8000, 8000, 740, 50 } // ...or, set your own edit limits
#endif
...
#define Y_BED_SIZE 215  // make the sanity check happy
...
#define HOMING_FEEDRATE_MM_M { 5000, 5000, 400 }
